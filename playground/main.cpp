...
int main(int argc, char *argv[])
{
    ...
    while (1) {
        ...
        if(ids.size() > 0){
          ...
          // double desired[3] = {0, 0, 0.8};
          // Mat desired_coord = Mat(3, 1, CV_64F, desired);
          //
          // desired_coord = (rotationMatrix * desired_coord) + tvecs[0];

          // cout << "desired coord: " << desired_coord.at<double>(0) << ":" << desired_coord.at<double>(1) << ":" << desired_coord.at<double>(2) << endl;
          // cout << "tvecs : " << tvecs[0][0] <<" "<< tvecs[0][1] <<" "<< tvecs[0][2] << endl;
    			// cout << "rvecs : " << rvecs[0][0] <<" "<< rvecs[0][1] <<" "<< rvecs[0][2] << endl;
